...
1. reshapes each image to `28 × 28 × 1`
2. converts pixel values to `float32`
3. scales pixels from `0–255` to `0–1`
4. converts digit labels to 10-class categorical vectors
